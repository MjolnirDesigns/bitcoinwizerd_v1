// components/ui/SubscriberWizerd2.tsx
"use client";
...
interface SubscriberWizerd2Props {
...
const SubscriberWizerd2: React.FC<SubscriberWizerd2Props> = ({
  ...
  return (
    ...
    >
      <div
        className="p-6 sm:p-8 rounded-xl border border-mystic-blue shadow-[0_0_15px_rgba(0,51,255,0.3)]"
        style={{
          background: `linear-gradient(135deg, #ff33cc, #ff9900, #ffff00, #33e000, #33ccff)`,
...
export default SubscriberWizerd2;